...
class TrainPipeline:
    ...
    def start_data_validation(self, data_ingestion_artifact: DataIngestionArtifact) -> DataValidationArtifact:
        ...
        """
        logging.info("Entered the start_data_validation of Train pipeline class")
        ...
        try:
            ...
            logging.info("Exited the start_data_validation method of Train pipleine class")
    ...
    def start_model_trainer(self, data_transformation_artifact: DataTransformationArtifact) -> ModelTrainerArtifact:
        """
        This model of TrainPipeline class is responsible for starting model training
        """
        try:
