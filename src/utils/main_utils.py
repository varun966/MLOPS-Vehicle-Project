...
def load_object(file_path: str) -> object:
    """
    Returns the model/object from project directory.
...
def drop_columns(df: DataFrame, cols: list) -> DataFrame:
    ...
    """
    logging.info("Entered the drop_columns methods of utils")

    try:
        df = df.drop(columns=cols, axis=1)

        logging.info("Exited the drop_column methods of utils")
