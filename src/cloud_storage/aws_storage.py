...
class SimpleStorageService:
    ...
    @staticmethod
    def read_object(object_name: str, decode: bool = True, make_readbale: bool = False) -> Union[StringIO,str]:
        """
        ...
        try:
            ...
            conv_func = lambda: StringIO(func()) if make_readbale else func()
            return conv_func()
        except Exception as e:
    ...
    def get_file_object(self, filename: str, bucket_name: str) -> Union[List[object], object]:
        ...
        Retrieves the file object(s) from the specified bucket based on the filename.
         Args: 
            ...
            bucket_name (str): The name of the S3 Object
        ...
        try:
            ...
            logging.info("Exited the get_file_object methid of SimpleStorageService class")
            return file_objs
        except Exception as e:
            raise MyException(e, sys) from e
    ...
    def load_model(self, model_name: str, bucket_name: str, model_dir: str = None) -> object:
        """
        Loads a serialized model from  the specified s3bucket.
        
        Args: 
            model_name (str): Name of the model file in the bucket.
            bucket_name (str): Name of the s3 object.
            model_dir (ste): Directory path within the bucket
            
        Returns:
            object: The deseralized model object.
        """
    ...
    def upload_file(self, from_filename: str, to_filename: str, bucket_name: str, remove: bool = True):
        """
        Uploads a local file to the specified s3 bucket file with an optional file deletion
        ...
        try: 
            ...
            # Deletes the local file if remove is True 
            if remove:
    ...
    def upload_df_as_csv(self, data_frame: DataFrame, local_filename: str, bucket_filename: str, bucket_name: str) -> None:
        """
        Uploads a DataFrame as CSV file to the specified S3 Bucket.
        ...
        """
        try:
            # Save DataFrame to CSV locally and the upload it
    ...
    def get_df_from_object(self, object_: object) -> DataFrame:
            ...
            try:
                content = self.read_object(object_, make_readbale=True)
    ...
    def read_csv(self, filename: str, bucket_name: str) -> DataFrame:
        ...
        Args:
            filename (str): The name of the file in the bucket and converts it to a DataFrame.
            bucket_name (str): The name of the s3 bucket.
