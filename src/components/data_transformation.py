...
class DataTransformation:
    ...
    def get_data_transformer_object(self) ->Pipeline:
        ...
        """
        logging.info("Enetered get_data_transformer_object of Data Transformation class")
        ...
        try:
            ...
            num_features = self.__schema_config['num_features']
            mm_columns = self.__schema_config['mm_columns']
            logging.info("Cols loaded into schema.")
            ...
            logging.info("Exception ocurred in get_transformer_object method of DataTransformation class")
            raise MyException(e, sys) from e
    ...
    def _rename_columns(self, df):
        ...
        for col in ["Vehicle_Age_lt_1_Year","Vehicle_Age_gt_2_Years"]:
    ...
    def _drop_id_column(self, df):
        ...
        drop_col = self.__schema_config['drop_columns']
