...
class ModelEvaluation:
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        Description: This function is used to evaluate trained Model
                     with Production model and choose the best Model
        ...
        try:
            ...
            if best_model is not None:
                ...
                logging.info(f"F1_Score-Production Model: {best_model_f1_score}, F1-Score-Trained Model: {trained_model_f1_score}")
