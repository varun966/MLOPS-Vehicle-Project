...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        On Failure: Writes an exception log and raise an exception
        """
        try:
            logging.info("Training RandomForestClassifer with specified parameters")

            # Splitting the train and test data into features and target variable
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        logging.info("Enetered initiate_model_trainer method of ModelTrainer class")
        """
        ...
        try:
            ...
            logging.info('Saving new model as performance is better then previous one.')
